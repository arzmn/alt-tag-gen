...
const features = [
  {
    ...
    description:
      'Upload image of your products/ blog to be published on your site ',
    icon: CloudArrowUpIcon,
  },
  {
    name: 'AI Analyzes the image',
    description: 'It only takes a second for our technology to examine the image and work its magic',
    icon: LockClosedIcon,
  },
  {
    name: 'You Get alt text',
    description: 'We generate an accurate description of the image, ready to be used on your site',
    icon: ServerIcon,
  },
]
          ...
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Fast as flash, smart as Jarvis. Yes you got it right!
              </p>
